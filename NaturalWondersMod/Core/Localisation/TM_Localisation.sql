...
-----------------------------------------------
	...
	("en_US",	"LOC_TM_FEATURE_PAITITI_DESCRIPTION",			"Three tile impassable natural wonder. Adjacent plots yield +1 [ICON_SCIENCE] Science, +2 [ICON_PRODUCTION] Production, +2 [ICON_CULTURE] Culture, +2 [ICON_FOOD] Food, +3 [ICON_GOLD] Gold, and +3 [ICON_FAITH] Faith."	),
